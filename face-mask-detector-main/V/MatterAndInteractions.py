...
link('08-ProblemP28', "Using the random function")
link('08-ProblemP29', "Photon emission using the random function")
link('08-ProblemP30', "Red and green photon emission using the random function")
...
link('17-right-hand-rule', "3D view of the v-cross-r right-hand rule for magnetic field")
